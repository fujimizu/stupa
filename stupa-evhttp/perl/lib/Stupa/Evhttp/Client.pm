...
Stupa::Evhttp::Client - client library of Stupa search engine
...
Stupa::Evhttp::Client is a client library of Stupa search engine.
...
Delete a document from Stupa server.
...
Stupa - an Associative Search Engine <http://code.google.com/p/stupa/>
